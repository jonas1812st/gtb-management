...
const getPresentState = (student: Student) => {
  ...
  return {
    ...
    state: currentVisitation !== undefined ? (currentVisitation.end !== null ? "visited" : "visiting") : "default",
  };
};
  ...
  const columns: ColumnDef<Student>[] = [
    {
      ...
      cell: ({ row: { original: student } }) => {
        ...
        return (
          <input
            type="checkbox"
            defaultChecked={presentState.visitation !== undefined && presentState.visitation.end === null}
      ...
      meta: {
        getCellContext: ({ row: { original: student } }) => {
          ...
          return {
            row: {
              style: {
                backgroundColor: presentState.state === "visiting" ? "#FEF9C3" : presentState.state === "visited" ? "#DCFCE7" : null,
              },
            },
          };
        },
      ...
      <tbody>
        ...
        {students.map((student, index) => {
          ...
          return (
            <Tr
              key={index + "_student"}
              className={presentState.state === "visiting" ? "bg-yellow-100" : presentState.state === "visited" ? "bg-green-100" : ""}
            >
              <Td>
                <input
                  type="checkbox"
