...
export default function LoginForm() {
  ...
  return (
    <form action={handleSubmit} className="w-full max-w-sm border rounded-lg pb-8 pt-3 px-8 flex flex-col space-y-5">
      <div className="flex flex-col space-y-1">
        <h2 className="text-2xl font-semibold">Login</h2>
        <p className="text-sm text-gray-600">Gib deinen Benutzernamen und dein Passwort ein, um dich einzuloggen.</p>
      </div>
